          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-custom hover:text-gray-300">
                    Sort
                    <ChevronDownIcon
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul
                  role="list"
                  className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-custom"
                >
                  {subCategories.map((category) => (
                    <li key={category.name}>
                      <a
              ...
              <div className="lg:col-span-3">
                <Products filteredSubCategory={filteredSubCategory} />
              </div>
            </div>
          </section>
        </main>
